...
<li><b>Shift+F10</b> — Open the game list context menu (Open save path, Open backup path, add save folder/registry path).</li>
<li><b>Arrow keys</b> — Move selection between rows when the game table has focus.</li>
